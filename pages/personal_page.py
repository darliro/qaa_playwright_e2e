...
class PersonalPage(BasePage):
    ...
    FIRST_NAME_FIELD: str = PERSONAL_PAGE["first_name_input"]
    ...
    def update_first_name(self, new_name: str) -> None:
        self.fill_field(self.FIRST_NAME_FIELD, new_name)
    ...
    def verify_first_name_is_updated(self, expected_name: str) -> None:
        expect(self.page.locator(self.FIRST_NAME_FIELD)).to_have_value(expected_name)
